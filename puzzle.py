...
# A is knave
knowledge0 = And(
    And(Or(AKnight, AKnave), Not(And(AKnight, AKnave))),  # A is either a knight or knave, but not both - XOR
...
knowledge1 = And(
    And(Or(AKnight, AKnave), Not(And(AKnight, AKnave))),  # A is either a knight or knave, but not both - XOR
    And(Or(BKnight, BKnave), Not(And(BKnight, BKnave))),  # B is either a knight or knave, but not both - XOR
...
# A and C are knights, B is knave
knowledge3 = And(
    And(Or(AKnight, AKnave), Not(And(AKnight, AKnave))),  # A is either a knight or knave, but not both - XOR
    And(Or(BKnight, BKnave), Not(And(BKnight, BKnave))),  # B is either a knight or knave, but not both - XOR
    And(Or(CKnight, CKnave), Not(And(CKnight, CKnave))),  # C is either a knight or knave, but not both - XOR
    Implication(AKnight, Not(AKnave)),
    Implication(BKnight, Not(BKnave)),
